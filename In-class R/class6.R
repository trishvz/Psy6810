...
# hits <- gamma(21)/gamma(N.matches+1)/gamma(20 - N.matches+1) 
hits <- choose(20,N.matches) # Number of ways to pick the matches)
#misses <- gamma(61)/gamma(spots - N.matches+1)/gamma(60 - spots + N.matches+1) 
misses <- choose(60,spots - N.matches) # Number of ways to pick the mismatches
